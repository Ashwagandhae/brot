...
export const typstTags = {
	codeSpace: Tag.define(tags.content),
	contentSpace: Tag.define(tags.content),
};
export const typstHighlight = styleTags({
	...
	Text: tags.content,
	Space: typstTags.codeSpace,
	"ListItem/Space": typstTags.contentSpace,
	"Heading/Space": typstTags.contentSpace,
	"Markup/Space": typstTags.contentSpace,
